...
func Retry(httpCall func() (resp *http.Response, err error)) (*http.Response, error) {
	var err error
...
func ClientPost(c *http.Client, url string, bodyType string, body io.Reader) (*http.Response, error) {
